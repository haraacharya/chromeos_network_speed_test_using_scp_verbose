...
up_speed=`sshpass -p "test0000" scp -v $test_file $ssh_server:/home/chronos/$test_file 2>&1 | \
...
down_speed=`sshpass -p "test0000" scp -v $ssh_server:$test_file /home/chronos/$test_file 2>&1 | \
  grep "Bytes per second" | \
